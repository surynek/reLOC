         ...
         if pd == md.directory:
           for sr in md.sources:
             ...
             if obj not in finished:
               ...
               makefile.write(src + "\n")
               makefile.write("\tg++ -Wall -Wextra -pedantic -Wno-long-long -Wno-unused-result -Wno-sign-compare -Wno-delete-non-virtual-dtor -Wno-class-memaccess -std=c++0x -g -c ")
         ...
         if pd == md.directory:
           for sr in md.sources:
             ...
             if obj not in finished:
               ...
               makefile.write("\tg++ -Wall -Wextra -pedantic -Wno-long-long -Wno-unused-result -Wno-sign-compare -Wno-delete-non-virtual-dtor -Wno-class-memaccess -g -std=c++0x -c ")
               for hdr_dir in header_dirs:
                 makefile.write("-I" + hdr_dir + " ")
               makefile.write("-o" + obj + " " + src + "\n")
               makefile.write("\n")
