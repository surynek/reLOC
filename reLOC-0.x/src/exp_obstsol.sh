...
#    echo './solver_reLOC --input-file=grid_'$SIZE'x'$SIZE'_r'$ROBOTS'_'$seed'.cpf --makespan-limit=64 --layer-limit=64 --total-timeout=256 --minisat-timeout=256 --encoding='$ENCODING' --output-file=grid_'$SIZE'x'$SIZE'_r'$ROBOTS'_'$seed'_'$ENCODING'.out > grid_'$SIZE'x'$SIZE'_r'$ROBOTS'_'$seed'_'$ENCODING'.txt'
    ./solver_reLOC '--input-file=obst_'$SIZE'x'$SIZE'_o'$OBST'_r'$ROBOTS'_'$seed'.cpf' '--N-obstacles='$OBST --makespan-limit=65536 --layer-limit=65536 --total-timeout=300 --minisat-timeout=300 '--encoding='$ENCODING '--output-file=obst_'$SIZE'x'$SIZE'_o'$OBST'_r'$ROBOTS'_'$seed'_'$ENCODING'.out' > 'obst_'$SIZE'x'$SIZE'_o'$OBST'_r'$ROBOTS'_'$seed'_'$ENCODING'.txt'
  done
done
