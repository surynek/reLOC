...
do
    ...
    ../insolver_reLOC '--suboptimal-ratio='$SUBOPT '--input-file=grid_'$SIZE'x'$SIZE'_r'$ROBOTS'_'$SEED'.cpf' '--total-timeout='$TIMEOUT '--minisat-timeout='$TIMEOUT '--encoding='$ENCODING '--output-file=grid_'$SIZE'x'$SIZE'_r'$ROBOTS'_'$SEED'_'$ENCODING'.out' > 'grid_'$SIZE'x'$SIZE'_r'$ROBOTS'_'$SEED'_'$ENCODING'.txt'
done
