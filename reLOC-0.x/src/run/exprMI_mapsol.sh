...
do
    ...
    ../insolver_reLOC 'y--input-file=map_'$MAP'_r'$ROBOTS'_'$SEED'.cpf' '--total-timeout='$TIMEOUT '--minisat-timeout='$TIMEOUT '--encoding='$ENCODING '--output-file=MAP_'$MAP'_r'$ROBOTS'_'$SEED'_'$ENCODING'.out' > 'map_'$MAP'_r'$ROBOTS'_'$SEED'_'$ENCODING'.txt'
done
